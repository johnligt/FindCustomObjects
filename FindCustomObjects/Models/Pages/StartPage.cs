...
namespace FindCustomObjects.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(WidgetPage), typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(ContentFolder) }, // Pages we can create under the start page...

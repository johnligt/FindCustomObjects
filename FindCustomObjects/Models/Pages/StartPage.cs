...
using FindCustomObjects.Models.Blocks;
...
namespace FindCustomObjects.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(WidgetPage), typeof(ContentFolder) }, // Pages we can create under the start page...
